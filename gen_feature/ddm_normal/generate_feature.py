...
class GenerateFeatures:
    ...
    def write_single_vector(self):
        ...
        with open("output_time.txt", "a") as output:
                output.write("%s\n" % label)
                output.write("%s\n" % self.feature_time)
...
def run_exp():
    ...
    # ===== gen graphs for normal features without rewire
    # Generate graphs for PAM - Done by Weiliang
    # g1 = GenGraphs(1000, 0.01, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_1000_001_20_10.txt")
    # print("done phase 1")
    #
    # g1 = GenGraphs(1000, 0.02, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_1000_002_20_10.txt")
    # print("done phase 2")
    #
    # g1 = GenGraphs(1500, 0.01, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_1500_001_20_10.txt")
    # print("done phase 3")
    #
    # g1 = GenGraphs(1500, 0.02, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_1500_002_20_10.txt")
    # print("done phase 4")
    #
    # g1 = GenGraphs(500, 0.01, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_500_001_20_10.txt")
    # print("done phase 5")
    #
    # g1 = GenGraphs(500, 0.02, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_500_002_20_10.txt")
    # print("done phase 6")
    #
    # g1 = GenGraphs(500, 0.05, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_500_005_20_10.txt")
    # print("done phase 7")

    # g1 = GenGraphs(900, 0.03, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_900_003_20_10.txt")
    # print("done phase 8")
    #
    # g1 = GenGraphs(1200, 0.015, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_1200_0015_20_10.txt")
    # print("done phase 9")

    # g1 = GenGraphs(800, 0.01, 10, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_800_001_10_10.txt")
    # print("done phase 10a")
    #
    # g1 = GenGraphs(1100, 0.01, 10, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("pam_1100_001_10_10.txt")
    # print("done phase 10b")
    #
    # print("pam normal done")

    # pam rewire 10


   # ===== gen graphs for normal features with rewire
    # Generate graphs for PAM - Done by Weiliang
    # g1 = GenGraphs(1000, 0.01, 20, 10)
    # g1.gen_pam()
    # print("graphs generation done")
    ...
    # print("done phase 10b")
    #
    # print("pam rewire done")



    # Generate graphs for ER - Done by Weiliang
    # g1 = GenGraphs(1000, 0.01, 20, 10)
    # g1.gen_er()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_1000_001_20_10.txt")
    # print("done phase 1")
    #
    # g1 = GenGraphs(1000, 0.02, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_1000_002_20_10.txt")
    # print("done phase 2")
    #
    # g1 = GenGraphs(1500, 0.01, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_1500_001_20_10.txt")
    # print("done phase 3")
    #
    # g1 = GenGraphs(1500, 0.02, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_1500_002_20_10.txt")
    # print("done phase 4")
    #
    # g1 = GenGraphs(500, 0.01, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_500_001_20_10.txt")
    # print("done phase 5")
    #
    # g1 = GenGraphs(500, 0.02, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_500_002_20_10.txt")
    # print("done phase 6")
    #
    # g1 = GenGraphs(500, 0.05, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_500_005_20_10.txt")
    # print("done phase 7")
    #
    # g1 = GenGraphs(900, 0.03, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_900_003_20_10.txt")
    # print("done phase 8")
    #
    # g1 = GenGraphs(1200, 0.015, 20, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_1200_0015_20_10.txt")
    # print("done phase 9")
    #
    # g1 = GenGraphs(800, 0.01, 10, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_800_001_10_10.txt")
    # print("done phase 10a")
    #
    # g1 = GenGraphs(1100, 0.01, 10, 10)
    # g1.gen_er()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("er_1100_001_10_10.txt")
    # print("done phase 10b")
    #
    # print("er normal done")

    # Generate graphs for ER rewire - Done by Weiliang
    # g1 = GenGraphs(1000, 0.01, 20, 10)
    # g1.gen_er()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs_rewire, g1.labels)
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_1000_001_20_10.txt")
    # print("done phase 1")
    #
    # g1 = GenGraphs(1000, 0.02, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_1000_002_20_10.txt")
    # print("done phase 2")
    #
    # g1 = GenGraphs(1500, 0.01, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_1500_001_20_10.txt")
    # print("done phase 3")
    #
    # g1 = GenGraphs(1500, 0.02, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_1500_002_20_10.txt")
    # print("done phase 4")
    #
    # g1 = GenGraphs(500, 0.01, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_500_001_20_10.txt")
    # print("done phase 5")
    #
    # g1 = GenGraphs(500, 0.02, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_500_002_20_10.txt")
    # print("done phase 6")
    #
    # g1 = GenGraphs(500, 0.05, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_500_005_20_10.txt")
    # print("done phase 7")
    #
    # g1 = GenGraphs(900, 0.03, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_900_003_20_10.txt")
    # print("done phase 8")
    #
    # g1 = GenGraphs(1200, 0.015, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_1200_0015_20_10.txt")
    # print("done phase 9")
    #
    # g1 = GenGraphs(800, 0.01, 10, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_800_001_10_10.txt")
    # print("done phase 10a")
    #
    # g1 = GenGraphs(1100, 0.01, 10, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_rewire_1100_001_10_10.txt")
    # print("done phase 10b")
    #
    # print("geo rewire done")
    #
    # with open("output.txt", "a") as output:
    #     output.write("=====\n")
    # with open("output_time.txt", "a") as output:
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_1000_001_20_10.txt")
    # print("done phase 1")
    #
    # g1 = GenGraphs(1000, 0.02, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_1000_002_20_10.txt")
    # print("done phase 2")
    #
    # g1 = GenGraphs(1500, 0.01, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_1500_001_20_10.txt")
    # print("done phase 3")
    #
    # g1 = GenGraphs(1500, 0.02, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_1500_002_20_10.txt")
    # print("done phase 4")
    #
    # g1 = GenGraphs(500, 0.01, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_500_001_20_10.txt")
    # print("done phase 5")
    #
    # g1 = GenGraphs(500, 0.02, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_500_002_20_10.txt")
    # print("done phase 6")
    #
    # g1 = GenGraphs(500, 0.05, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_500_005_20_10.txt")
    # print("done phase 7")
    #
    # g1 = GenGraphs(900, 0.03, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_900_003_20_10.txt")
    # print("done phase 8")
    #
    # g1 = GenGraphs(1200, 0.015, 20, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_1200_0015_20_10.txt")
    # print("done phase 9")
    #
    # g1 = GenGraphs(800, 0.01, 10, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_800_001_10_10.txt")
    # print("done phase 10a")
    #
    # g1 = GenGraphs(1100, 0.01, 10, 10)
    # g1.gen_geo()
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("geo_1100_001_10_10.txt")
    # print("done phase 10b")
    #
    # print("geo done")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_1000_001_20_10.txt")
    print("done phase 1")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_1000_002_20_10.txt")
    print("done phase 2")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_1500_001_20_10.txt")
    print("done phase 3")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_1500_002_20_10.txt")
    print("done phase 4")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_500_001_20_10.txt")
    print("done phase 5")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_500_002_20_10.txt")
    print("done phase 6")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_500_005_20_10.txt")
    print("done phase 7")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_900_003_20_10.txt")
    print("done phase 8")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_1200_0015_20_10.txt")
    print("done phase 9")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_800_001_10_10.txt")
    print("done phase 10a")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_rewire_1100_001_10_10.txt")
    print("done phase 10b")

    print("ddm rewire done")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_1000_001_20_10.txt")
    print("done phase 1")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_1000_002_20_10.txt")
    print("done phase 2")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_1500_001_20_10.txt")
    print("done phase 3")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_1500_002_20_10.txt")
    print("done phase 4")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_500_001_20_10.txt")
    print("done phase 5")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_500_002_20_10.txt")
    print("done phase 6")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_500_005_20_10.txt")
    print("done phase 7")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_900_003_20_10.txt")
    print("done phase 8")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_1200_0015_20_10.txt")
    print("done phase 9")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_800_001_10_10.txt")
    print("done phase 10a")
    ...
    print("feature generation done")
    write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    write_obj.write_by_append("ddm_1100_001_10_10.txt")
    print("done phase 10b")

    print("ddm done")

     # ======= by this line, above is finished experiments

    # g = nx.random_geometric_graph(500, 0.042)
    # v1 = FeatureVectorGenerator(g, [])
    # print(v1.feature_vector)



    # # Generate graphs for ER - Done by
    # g1 = GenGraphs(200, 0.01, 10, 10)
    # g1.gen_er()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    ...
    # Generate graphs for GEO - Done by Weiliang
    # g1 = GenGraphs(1000, 0.01, 10, 10)
    # g1.gen_geo()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("total_output.txt")
    # print("done")

    # # Generate graphs for DDM - Done by
    # g1 = GenGraphs(200, 0.01, 10, 10)
    # g1.gen_ddm()
    # print("graphs generation done")
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    ...
    # g1.gen_ddm()
    # print("graphs generation done")
    # # gen = FeatureVectorGenerator(g1.graphs[0], [])
    # # print(gen.feature_vector)
    # generator = FeatureVectorsGenerator(g1.graphs, g1.labels)
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("ouput.txt")
    ...
    # print("feature generation done")
    # write_obj = WriteToFile(generator.feature_vectors, generator.labels)
    # write_obj.write_by_append("ouput_rewire.txt")
    # print("done")
    #
    # # Generate graphs for ER - Done by
    # g1 = GenGraphs(1000, 0.01, 10, 10)
